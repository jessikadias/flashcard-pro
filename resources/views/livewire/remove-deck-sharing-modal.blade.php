            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-[#223464]/10 sm:mx-0 sm:h-10 sm:w-10">
                        <x-icons.alert class="text-[#223464]" />
                    </div>
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Are you sure you want to remove this deck from your shared decks? 
                                This action will only remove your access to the deck, not delete the deck itself.
                            </p>
                        </div>
                    </div>
                </div>
